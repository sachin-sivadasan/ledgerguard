...
class MrrReportProvider extends ChangeNotifier {
  final MrrReportService _service;
  ...
  MrrReport _mockReport() {
    final now = DateTime.now();
    // Trend rising to ~1_248_000 across 8 points.
    const trendValues = [
      1105000,
      1128000,
      1152000,
