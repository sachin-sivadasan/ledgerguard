              ...
              final overviewCard = LgCard(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _Info(
                      'First Install',
                      dateFmt.format(store.firstInstallDate),
                    ),
                    _Info(
                      'Last Interaction',
                      dateFmt.format(store.lastInteraction),
                    ),
                    Row(
                      children: [
          ...
          children: storeEvents.map((event) {
            return Padding(
              ...
              child: Row(
                ...
                children: [
                  Icon(
                    _appEventIcon(event.type),
                    size: 18,
                    color: _appEventColor(event.type),
                  ),
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            LgBadge(
                              label: _appEventBadge(event.type),
                              tone: _appEventTone(event.type),
                            ),
                          ],
                        ),
                        Text(
        ...
        children: legacyTimeline.reversed.map((event) {
          return Padding(
            ...
            child: Row(
              ...
              children: [
                Icon(
                  _legacyIcon(event.type),
                  size: 18,
                  color: _legacyColor(event.type),
                ),
                const SizedBox(width: LgSpacing.s300),
                Expanded(
                  child: Column(
